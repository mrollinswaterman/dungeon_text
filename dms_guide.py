...
boulder_lines_true = {
    "str": [f" You push the boulder aside and continue on your way.\n", f" You smash the boulder to rubble for daring to stand in your way.\n"],

    "dex": [f" You manage to squeeze by the boulder.\n", f" You're flexible enough to make it past.\n"]
}
boulder_line_false = {
    "str": [f" You push with all your might, but the boulder doesn't budge. You'll need to push a little harder.\n", 
            f" You punch the boulder. Nothing happens. Maybe if you punched it harder?\n"],

    "dex": [f" You do a backflip. The boulder is unimpressed. You think you might be able to squeezing past it, if you tried.\n",
            f" You try to squeeze past, but don't quite make it. You wriggle yourself out before you get stuck.\n"]
}
...
boulder.add_end_message(f" You are forced to double back and find another way through.\n")

#ROCKCLIMBING EVENT
rock_wall = events.Event()
rock_wall_lines_true = {
    "str": [f" With nothing but your own brute strength, you haul yourself up the wall.\n", f"You manage to clamber over the wall.\n"],

    "dex": [f" placeholder dex true\n"]
}
rock_wall_line_false = {
    "str": [f" placeholder str false\n"],
 

    "dex": [f" placeholder dex false\n"]
}
...
rock_wall.add_end_message(f" You are forced to double back and find another way through.\n")
